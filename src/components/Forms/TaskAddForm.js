                ...
                <form onSubmit={handleSubmit}>
                    <div className="content-edit">
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                <label>Type *</label>
                                <input className="form-control" type="text" name="_type" value={editedTask._type} onChange={handleChange}/>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                                <label>Status *</label>
                                <input className="form-control" type="text" name="_status" value={editedTask._status} onChange={handleChange}/>
                            </div>
                        </div>
                    </div>
